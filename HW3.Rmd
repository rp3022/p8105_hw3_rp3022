...
Outliers : outliers can be observed in the graph. The most extreme outlier was -14 degrees celsius for January and 14        degrees celsius for July.


* Making 2 panel plots for tmax vs tmin and snowfall

```{r tmin vs tmax and snowfall plot}
